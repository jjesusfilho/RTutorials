...
## Questions
- Why did I set sheet_name to be sheet_name=1? What does this allow for my function.
...
include_cohort(05, "2014-15") # just try it out on one example
...
## You try - create a function that will change all the NAs in es_grad to 0
...
- Extra credit: Change all the 1's to YES and the 0's to No in both es_grad and backfilled
